...
def main(df):
    ...
    # missing_value_handler.set_strategy(FillMissingValuesStrategy(method='median'))
    # df_filled = missing_value_handler.handle_missing_values(df)
    # print("------ DataFrame after filling missing values with median ------")
    # print(df_filled)
    
    # missing_value_handler.set_strategy(FillMissingValuesStrategy(method='mode'))
    # df_filled = missing_value_handler.handle_missing_values(df)
    # print("------ DataFrame after filling missing values with mode ------")
    # print(df_filled)
    
    # missing_value_handler.set_strategy(FillMissingValuesStrategy(method='constant', fill_value=-1))
    # df_filled = missing_value_handler.handle_missing_values(df)
    # print("------ DataFrame after filling missing values with constant value ------")
    # print(df_filled)
    
    # missing_value_handler.set_strategy(FillMissingValuesStrategy(method='invalid_method'))
    # df_filled = missing_value_handler.handle_missing_values(df)
    # print("------ DataFrame after filling missing values with invalid method ------")
    # print(df_filled)
