...
class OutlierDetector(ABC):
    """
    Abstract Context for Outlier Detection
    """
    ...
    def handle_outliers(self, df: pd.DataFrame, method="remove", **kwargs) -> pd.DataFrame:
        logging.info(f"Handling outliers using the '{method}' method.")
...
def main(df):
    ...
    # outlier_detector.visualize_outliers(df_numeric, features=df_numeric.columns)
